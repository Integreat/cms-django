...
class OfferTemplateView(TemplateView):
    ...
    def post(self, request, offer_template_id=None):
        ...
        form = OfferTemplateForm(request.POST, instance=offer_template_instance)
        ...
        if offer_template_instance:
            messages.success(request, _("Offer template was successfully saved"))
        else:
            messages.success(request, _("Offer template was successfully created"))
