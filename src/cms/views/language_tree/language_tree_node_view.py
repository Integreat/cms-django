...
@method_decorator(permission_required("cms.view_language_tree_node"), name="dispatch")
@method_decorator(permission_required("cms.change_language_tree_node"), name="post")
