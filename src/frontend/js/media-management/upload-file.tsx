...
export default function UploadFile({ parentDirectory, apiEndpoints }: Props) {
      ...
      <div className="w-full max-w-full">
        <div className="header">
          <div className="flex flex-wrap">
            <div>
              <h2 className="heading font-normal mb-2">
      ...
      >
        ...
        <div className="flex items-center justify-start mt-6">
          <input
            ...
            value="Absenden"
          />
          <Button disabled={isLoading} href={listingRoute} label="Zurück" />
        </div>
      </form>
    </div>
  );
